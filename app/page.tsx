  ...
  return (
    <main className="relative bg-[#050505]">
      ...
      <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-6 py-4 md:px-10">
        {/* Logo - Left */}
        <a href="#" onClick={(e) => e.preventDefault()} onClick={(e) => e.preventDefault()} className="text-sm font-semibold tracking-tight text-white transition-opacity hover:opacity-70">
          {""}
        </a>

        {/* Nav Links - Center (hidden on mobile) */}
        <div className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-8 md:flex">
          <a href="#" onClick={(e) => e.preventDefault()} onClick={(e) => e.preventDefault()} className="text-xs uppercase tracking-widest text-white/50 transition-colors hover:text-white">
            Products
          </a>
          <a href="#" onClick={(e) => e.preventDefault()} onClick={(e) => e.preventDefault()} className="text-xs uppercase tracking-widest text-white/50 transition-colors hover:text-white">
            Technology
        ...
        {/* CTA - Right */}
        <button className="rounded-full border border-white/20 bg-transparent px-5 py-2 text-xs font-medium text-white transition-all hover:bg-white hover:text-black" onClick={() => toast.success("Pre-order reserved!", { description: "You'll be first to know when Momo X ships." })}>
          Pre-order
        </button>
      </nav>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-12 md:py-32">
          <div className="grid gap-12 md:grid-cols-2 md:gap-16">
            <div>
              ...
              <button className="mt-8 rounded-full bg-white px-8 py-3 text-sm font-medium text-black transition-opacity hover:opacity-90" onClick={() => toast.success("Added to cart", { description: "Momo X · $549 · Free shipping" })}>
                Order Now — $549
              </button>
            </div>
          ...
          <div className="mt-20 flex flex-wrap items-center justify-between gap-4 border-t border-white/5 pt-8 text-xs text-white/30">
            ...
            <div className="flex gap-6">
              <a href="#" onClick={(e) => e.preventDefault()} onClick={(e) => e.preventDefault()} className="transition-colors hover:text-white/60">
                Privacy
              </a>
              <a href="#" onClick={(e) => e.preventDefault()} onClick={(e) => e.preventDefault()} className="transition-colors hover:text-white/60">
                Terms
